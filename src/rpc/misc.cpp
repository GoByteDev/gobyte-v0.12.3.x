...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\"")
            + HelpExampleRpc("validateaddress", "\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\"")
        );
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        std::string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\\\",\\\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\\\",\\\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\\\"]\"")
        ;
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}")
        );
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}")
        );
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}")
        );
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}")
        );
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"]}")
        );
