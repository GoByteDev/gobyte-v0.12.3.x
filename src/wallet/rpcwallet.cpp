...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\", \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"")
            + HelpExampleRpc("getaccount", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"")
        );
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\\\":0.01,\\\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\\\":0.01,\\\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\\\":0.01,\\\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\\\":0.02}\", 6, false, \"testing\"")
        );
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\\\",\\\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\\\",\\\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\\\"]\"")
        ;
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 0))
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\" 1.0") +
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\\\",\\\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"GYFDwB8u8rDbPm1xDJbskWRrRbyLigHiXR\\\",\\\"GYrLnsCQ3MJghNn98sM4JDKZCT2dQKUGMp\\\"]\"")
        );
