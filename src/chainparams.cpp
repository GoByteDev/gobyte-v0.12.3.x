...
public:
    CMainParams() {
        ...
        consensus.BIP65Height = 115890;
        consensus.BIP66Height = 115890;
        consensus.DIP0001Height = 115890;
        ...
        consensus.nPowKGWHeight = 700; // nPowKGWHeight >= nPowDGWHeight means "no KGW"
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nWindowSize = 3000;
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0001].nThreshold = 2400; // 80% of 3000

        // Deployment of BIP147
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nStartTime = 1557360000; // Mar 5th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nTimeout = 1588982400; // Mar 5th, 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nWindowSize = 3000;
        consensus.vDeployments[Consensus::DEPLOYMENT_BIP147].nThreshold = 2400; // 80% of 3000
		...
		// Need original address from hisyam, this is from Marknl
        strSporkAddress = "GSVJNSL9uNsjQ5xQtZEYF9MvLqsJp5DGhQ";
        ...
        chainTxData = ChainTxData{
            1529183938, // * UNIX timestamp of last known number of transactions
            245030,   // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        consensus.nSuperblockStartBlock = 15600; // NOTE: Should satisfy nSuperblockStartBlock > nBudgetPaymentsStartBlock
        ...
        consensus.fPowNoRetargeting = false;
        consensus.nPowKGWHeight = 650; // nPowKGWHeight >= nPowDGWHeight means "no KGW"
        ...
        fMineBlocksOnDemand = false;
        fAllowMultipleAddressesFromGroup = true; // Allow to nodes within same /16 (IPv4)
        fAllowMultiplePorts = true;	// Allow on testnet only

        nPoolMaxTransactions = 3;
        nFulfilledRequestExpireTime = 5*60; // fulfilled requests expire in 5 minutes

		// This address is from Marknl
        strSporkAddress = "nKEsa7SGWAjJawPhcTaJUTk2dVzXmcodyG";
...
public:
    CDevNetParams() {
        ...
        fMineBlocksOnDemand = false;
        fAllowMultipleAddressesFromGroup = true; // Allow to nodes within same /16 (IPv4)
        fAllowMultiplePorts = true;	// Allow on devnet
...
public:
    CRegTestParams() {
        ...
        fAllowMultipleAddressesFromGroup = true; // Allow to nodes within same /16 (IPv4)
        fAllowMultiplePorts = true;	// Allow on regtest


        nFulfilledRequestExpireTime = 5*60; // fulfilled requests expire in 5 minutes

        // privKey: cXqP2bEJdzMHWEQST34UqRsYu9PQX42NpP3E9pbZSRfDM5BRff2f
        strSporkAddress = "nKEsa7SGWAjJawPhcTaJUTk2dVzXmcodyG";
