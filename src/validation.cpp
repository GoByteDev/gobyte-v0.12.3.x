...
bool CheckBlock(const CBlock& block, CValidationState& state, const Consensus::Params& consensusParams, bool fCheckPOW, bool fCheckMerkleRoot)
{
    ...
    if(sporkManager.IsSporkActive(SPORK_3_INSTANTSEND_BLOCK_FILTERING)) {
        ...
        LogPrintf("CheckBlock(GOBYTE): spork is off, skipping transaction locking checks\n");
    }
    ...
    if(Params().NetworkIDString() == CBaseChainParams::MAIN && nHeight <= 68589){
        ...
        if (block.nBits != nBitsNext)
            return state.DoS(100, false, REJECT_INVALID, "bad-diffbits", false, 
				strprintf("incorrect proof of work at %d block.nBits: %d nBitsNext: %d: pindexPrev: %d",
					nHeight, block.nBits, nBitsNext, pindexPrev->nHeight));
    }
	
	/*
	2019-05-10 19:55:07 ERROR: AcceptBlockHeader: Consensus::ContextualCheckBlockHeader: 
	0000000b5f8eb7d2ed17213b8efa08abb75d7bf935b3f32ace6d6b47f7b15eec, 
	bad-diffbits, incorrect proof of work at 719 block.nBits: 487315670 nBitsNext: 503349356: pindexPrev: 718 (code 16)

	719 bits: 487315670 "bits": "1d0bd8d6"
	nBitsNext = 503349356 "bits": "1e00806c"
	*/
